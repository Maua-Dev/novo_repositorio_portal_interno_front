...
export default function MembersArea({ addMember }: MembersAreaProps) {
    ...
    return(
        ...
        <div className={`${darkTheme ? `scrollbar-thumb-[#8F9A98] scrollbar-track-[#484848]` : `scrollbar-thumb-[#8F9A98] scrollbar-track-[#E8ECEB]`} flex flex-col overflow-y-auto scrollbar-thin px-5 gap-2 h-70`}>
            <ChooseMemberCard></ChooseMemberCard>
            <ChooseMemberCard></ChooseMemberCard>
            <ChooseMemberCard></ChooseMemberCard>
            <ChooseMemberCard></ChooseMemberCard>
            <ChooseMemberCard></ChooseMemberCard>
        ...
        <div className={`${darkTheme ? `border-[#484848]` : `border-[#CAD0CF]`} flex h-15 border-t items-center transition-all duration-300`}>
            <button onClick={addMember} className={`${darkTheme ? `text-[#484848] border-[#484848]` : `text-[#737E7D] border-[#CAD0CF]`} flex w-1/2 h-full font-bold border-r justify-center items-center transition-all duration-300`}>
                <p className="text-xl cursor-pointer w-fit">Salvar</p>
            </button>
            <button onClick={addMember} className={`${darkTheme ? `text-[#484848]` : `text-[#737E7D]`} flex w-1/2 h-full font-bold justify-center items-center transition-all duration-300`}>
