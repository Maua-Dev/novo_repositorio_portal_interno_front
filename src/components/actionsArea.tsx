...
export default function ActionArea({list, toggleOpen, toggleChosen, save}: MembersAreaProps) {
    ...
    const [searchAreaByName, setSearchAreaByName] = useState("")
    ...
    return(
        ...
        <div className="flex w-full justify-between p-5">
            ...
            <div className={`${darkTheme ? `bg-[#484848]` : `bg-[#AEB6B5]`} flex px-2 justify-between items-center text-white w-1/2 rounded-lg transition-all duration-300`}>
                <input type="text" placeholder="BUSCAR AÇÃO" value={searchAreaByName} onChange={(e) => setSearchAreaByName(e.target.value)} className="focus:outline-none text-white font-[Oswald] w-8/10"/>
